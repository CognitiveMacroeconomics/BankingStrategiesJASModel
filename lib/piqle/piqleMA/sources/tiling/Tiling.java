...
/** A Tiling is a set of Tiles, with a method for finding a Tile associated with a (state,action) couple. Specific implementations must be done separately for each problem, provided this problem implements the TileAbleContraintes interface.
 */
...
*/
    ...
    protected ArrayList dejaVu=null;

    protected ArrayList getAlreadySeen(){return this.dejaVu;}

    /** Find the tile associated with (s,a) */
    abstract protected Tile computeTile(State s,Action a); 
...
TODO DEBUG : USELESS (overwritten in all sub classes)
    */
    public Tile getTile(State s, Action a){
