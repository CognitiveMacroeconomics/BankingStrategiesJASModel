...
public class SelectionneurWatkinsNNSingle extends SelectionneurWatkins{

  

  
    public SelectionneurWatkinsNNSingle(double l){
	super(l); 
    ...
    /** Auxiliary/Debug : makes it possible to inspect the underlying Neural Network.*/
	 ...
	 return ((StockageNNSingle)memoire).getWeight(i,j,k); 
     }
     

    /** Auxiliary/Debug : makes it possible to inspect the underlying Neural Network.*/
     public int getSizeOfLayer(int i){
	 return ((StockageNNSingle)memoire).getSizeOfLayer(i);
     }
