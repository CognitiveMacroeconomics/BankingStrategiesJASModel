...
public class MaabacState extends AbstractState{
    ...
    public MaabacState(Contraintes ct){
	super(ct); 
    ...
    public MaabacState(Contraintes ct,int t){
	super(ct); 
	this.taille=t; 
	this.contractionValues=new int[this.taille];
	this.maxValues=new int[this.taille]; 
    ...
    public double getDdir(){return this.direction;}
     ...
     /** Clone */
    public State copy(){
	MaabacState neuf=new MaabacState(myContraintes,this.taille); 
    ...
    public int tailleCodage(){return this.taille+4;}
