...
public class TDFASelector implements ISelector{
  /**
    ...
    public void setFreeze(boolean t){this.freeze=t;}; 
  
    public boolean getFreeze(){return this.freeze;}
...
/** We always need a part of randomness */
    ...
    */
    protected double decayAlpha=0.99999; 
    ...
    */
    ...
    protected TileAbleEnvironment universe; 

    public void setWorld(TileAbleEnvironment u){this.universe=u;}
    public TileAbleEnvironment getWorld(){return this.universe;}
    ...
    */
	...
	if(geometricDecay){
	    ...
	    alpha=0.05/Math.pow(count+1.0,this.alphaDecayPower);
	}
 ...
 /** How to implement randomness ? 
    ...
    */
	...
	if(this.freeze) return meilleure; 
	...
	String s="Tile coding algorithm\n"; 
	s+="Tau : "+tau+"\n"; 
	s+="Gamma : "+gamma+"\n"; 
	s+="Alpha : "+alpha+"\n"; 
 	s+="Lambda :"+lambda+"\n";
	if(this.geometricDecay) s+="Geometrical alpha decay  "+decayAlpha+"\n"; 
	else s+="Exponential alplha decay "+alphaDecayPower+"\n"; 
	if(rouletteWheel) s+="Randomness by mean of roulette wheel\n"; 
	if(boltzmann) s+="Randomness by mean of Boltzmann\n"; 
	if(epsilonGreedy) s+="Randomness by epsilon greedy method\n"; 
	s+=universe.toString(); 
	return s; 
    }
